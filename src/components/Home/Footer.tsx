    ...
    <footer className="bg-black dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 dark:border-gray-800">
          <div>
            <p className="font-bold text-lg text-white dark:text-white">
              Services
            </p>
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <Link
                  href="/"
                  className="text-white hover:scale-110 transition hover:opacity-75 dark:text-gray-200"
                >
                  1on1 Coaching
                </Link>
              </li>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">
          &copy; 2024. Mhdyshah. All rights reserved.
        </p>
      </div>
    </footer>
  );
