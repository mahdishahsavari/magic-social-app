...
const words = `I use Next.js and typescript with tailwindcss ui styling and feature it with Gemini google AI util. I have 3 years of experience Right now and i wanna improve my experience with creating beautiful and responsive applications. have a fun and thousands of thanks :)`;
  ...
  return (
    <div className="my-10 flex flex-col items-center justify-center gap-8">
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-black dark:bg-black w-full gap-4 mx-auto px-8">
        <Card title="Next.js" icon={<LogoIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Typescript" icon={<LogoIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="React" icon={<LogoIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="cursor-pointer border border-white group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem]"
    >
...
const LogoIcon = () => {
  return (
    <Image
      ...
      width={120}
      height={120}
      className="rounded-full text-white dark:text-white group-hover/canvas-card:text-white"
    />
  );
};
